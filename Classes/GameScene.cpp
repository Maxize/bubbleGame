...
Bubble* GameScene::randomBubble()
{
	...
	do 
	{
		...
		if (pBubble && Bubble::create(g_bubbleName[color].c_str()))
		{
...
bool GameScene::onTouchBegan(CCTouch *pTouch, CCEvent *pEvent)
{
	return true;
}

void GameScene::onTouchMoved(CCTouch *pTouch, CCEvent *pEvent)
{
